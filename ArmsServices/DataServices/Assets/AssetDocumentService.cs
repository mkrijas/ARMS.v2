    ...
    public class AssetDocumentService : IAssetDocumentService
    {
        ...
        public AssetDocumentModel Update(AssetDocumentModel model)
        {
            List<SqlParameter> parameters = new List<SqlParameter>
            {
               ...
               new SqlParameter("@Owndamage", model.OwnDamage),
               new SqlParameter("@ODGST", model.ODGST),
               new SqlParameter("@ThirdParty", model.ThirdParty),
               new SqlParameter("@TPGST", model.TPGST),
        ...
        private AssetDocumentModel GetModel(IDataRecord dr)
        {
            return new AssetDocumentModel
            {
                ...
                OwnDamage = dr.GetDecimal("OwnDamage"),
                ODGST = dr.GetDecimal("ODGST"),
                ThirdParty = dr.GetDecimal("ThirdParty"),
                TPGST = dr.GetDecimal("TPGST"),
