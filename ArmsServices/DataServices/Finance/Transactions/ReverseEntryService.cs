...
namespace ArmsServices.DataServices
{
    public class ReverseEntryService : IReverseEntryService
    {
        ...
        public PagedResult<CancellationReasonCodesByDocumentType> SelectAll(int? BranchID, int page, int pageSize, string search, bool _IsApproved)
        {
            ...
            List<CancellationReasonCodesByDocumentType> list = [];
            int? countOf = 0;
            foreach (IDataRecord dr in Iservice.GetDataReader("[usp.Finance.Transaction.Reverse.Select]", parameters))
            {
            ...
            return new PagedResult<CancellationReasonCodesByDocumentType>
            {
                Items = list,
