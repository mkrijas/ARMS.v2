...
namespace ArmsServices.DataServices
{
    public class SundryMaintenanceService : ISundryMaintenanceService
    {
        ...
        public PagedResult<SundryMaintenanceModel> SelectAll(int? BranchID, int page, int pageSize, string search, bool _IsApproved)
        {
            ...
            List<SundryMaintenanceModel> list = [];
            int? countOf = 0;
            foreach (IDataRecord dr in Iservice.GetDataReader("[usp.Finance.Transactions.SundryMaintenance.Select]", parameters))
            {
            ...
            return new PagedResult<SundryMaintenanceModel>
            {
                Items = list,
